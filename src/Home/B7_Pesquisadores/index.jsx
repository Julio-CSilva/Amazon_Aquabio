...
const PesquisadoresB7 = () => {
  ...
  const pesquisadores = [
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/larissa-martins-brito-e-silva-2b93671a8/",
      orcid: "",
  ...
  const handleNext = () => {
    if (startIndex + cardsPerView < pesquisadores.length) {
  ...
  return (
    ...
    >
      ...
      <HStack
        ...
        p={{ base: "0 0 2rem 0", md: "0 0 10rem 0" }}
      >
        <IconButton
          icon={<ArrowBackIcon />}
          onClick={handlePrev}
        ...
        <IconButton
          ...
          onClick={handleNext}
          isDisabled={startIndex + cardsPerView >= pesquisadores.length}
          aria-label="Próximo"
        />
      </HStack>
    </Box>
